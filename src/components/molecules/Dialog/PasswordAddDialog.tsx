...
const PasswordAddDialog = () => {
  ...
  return (
    <div className="password-add-dialog">
      ...
      >
        <CustomDialogTitle title={t('component.dialog.title.addPassword')} close={() => handleClose()} />
        <CustomDialogContent>
          <form id="password-form" onSubmit={handleSubmit(onSubmit)} autoComplete="new-password">
            ...
            />
            <CustomTextField id="email" label={t('component.form.email')} register={register} error={errors.email} />
            <CustomTextField
              id="website"
            ...
            />
            <CustomSelect id="tag" label={t('component.form.tag')} register={register} error={errors.tag}>
            ...
            <CustomSelect id="group" label={t('component.form.group')} register={register} error={errors.group}>
              <CustomMenuItem value={''}>{'None'}</CustomMenuItem>
            ...
            <CustomTextArea id="notes" label={t('component.form.note')} register={register} error={errors.notes} />
          </form>
        </CustomDialogContent>
        <CustomDialogActions>
          {isSubmitting ? (
